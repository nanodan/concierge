// CommonJS wrapper for markdown functions (for testing)
// Duplicated from public/js/markdown.js to avoid ES module issues
...
module.exports = { escapeHtml, renderMarkdown, clearMarkdownCache, getMarkdownCacheSize };
